...
\caption[Old Phase: Concurrent Mark summary statistics]{Summary statistics for \textbf{Old Phase: Concurrent Mark} across all variants. Values in ms; single-object benchmark uses per-run maxima, multi-object uses per-run averages ($n=250$ per variant).}\label{tab:stats-old-concurrent-mark} \\
\toprule

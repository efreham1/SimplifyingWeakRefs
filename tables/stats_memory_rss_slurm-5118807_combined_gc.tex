...
\caption[Total process RSS summary statistics]{Summary statistics for \textbf{RSS} per-run maximum across all variants. Values in MB ($n=250$ per variant).}\label{tab:stats-memory-rss} \\
\toprule

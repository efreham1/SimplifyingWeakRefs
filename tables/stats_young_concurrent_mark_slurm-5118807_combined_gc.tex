...
\caption[Young Phase: Concurrent Mark summary statistics]{Summary statistics for Young Phase: Concurrent Mark across all variants. Values in ms, single-object benchmark uses per-run maxima, multi-object uses per-run averages ($n=100$ per variant).}\label{tab:stats-young_concurrent_mark} \\
\toprule

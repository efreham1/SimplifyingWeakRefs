...
\caption[Young Generation (Promote All) summary statistics]{Summary statistics for Young Generation (Promote All) across all variants. Values in ms, single-object benchmark uses per-run maxima, multi-object uses per-run averages ($n=100$ per variant).}\label{tab:stats-young_gen} \\
\toprule

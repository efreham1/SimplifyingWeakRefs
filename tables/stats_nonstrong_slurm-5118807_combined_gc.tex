...
\caption[Non-Strong Processing summary statistics]{Summary statistics for \textbf{Non-Strong Processing} across all variants. Values in ms; single-object benchmark uses per-run maxima, multi-object uses per-run averages ($n=250$ per variant).}\label{tab:stats-nonstrong} \\
\toprule

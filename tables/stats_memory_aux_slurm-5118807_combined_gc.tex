...
\caption[Auxiliary GC memory summary statistics]{Summary statistics for \textbf{Aux Memory} per-run maximum across all variants. Values in MB ($n=250$ per variant).}\label{tab:stats-memory-aux} \\
\toprule

...
\caption[Auxiliary GCr memory summary statistics]{Summary statistics for \textbf{Auxiliary GCr Memory} per-run maximum across all variants. Values in MB ($n=250$ per variant).}\label{tab:stats-memory-aux} \\
\toprule

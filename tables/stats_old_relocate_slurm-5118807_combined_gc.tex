...
\caption[Old Phase: Concurrent Relocate summary statistics]{Summary statistics for Old Phase: Concurrent Relocate across all variants. Values in ms, single-object benchmark uses per-run maxima, multi-object uses per-run averages ($n=100$ per variant).}\label{tab:stats-old_relocate} \\
\toprule

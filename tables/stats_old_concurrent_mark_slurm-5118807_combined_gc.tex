...
\caption[Old Phase: Concurrent Mark summary statistics]{Summary statistics for Old Phase: Concurrent Mark across all variants. Values in ms, single-object benchmark uses per-run maxima, multi-object uses per-run averages ($n=100$ per variant).}\label{tab:stats-old_concurrent_mark} \\
\toprule

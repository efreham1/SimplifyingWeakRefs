...
\caption[Major Collection summary statistics]{Summary statistics for \textbf{Major Collection} across all variants. Values in ms; single-object benchmark uses per-run maxima, multi-object uses per-run averages ($n=250$ per variant).}\label{tab:stats-major} \\
\toprule

...
\caption[Young Generation (Promote All) summary statistics]{Summary statistics for \textbf{Young Generation (Promote All)} across all variants. Values in ms; single-object benchmark uses per-run maxima, multi-object uses per-run averages ($n=250$ per variant).}\label{tab:stats-young-gen} \\
\toprule

\begin{table}[t]
\centering
\caption{Summary statistics for Concurrent Mark Follow across all variants. Values in ms; single-object benchmark uses per-run maxima, multi-object uses per-run averages ($n=250$ per variant).}

...
\caption[Concurrent Mark Follow summary statistics]{Summary statistics for \textbf{Concurrent Mark Follow} across all variants. Values in ms; single-object benchmark uses per-run maxima, multi-object uses per-run averages ($n=250$ per variant).}\label{tab:stats-markfollow} \\
\toprule

...
\caption[Young Phase: Concurrent Relocate summary statistics]{Summary statistics for \textbf{Young Phase: Concurrent Relocate} across all variants. Values in ms; single-object benchmark uses per-run maxima, multi-object uses per-run averages ($n=250$ per variant).}\label{tab:stats-young-relocate} \\
\toprule

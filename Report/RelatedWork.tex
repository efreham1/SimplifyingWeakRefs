...
In summary, Go presents weak semantics as an explicit, callback-less non-owning reference mechanism and treats finalisation as an auxiliary facility with carefully constrained expectations. This separation between weak reachability and cleanup notification is a deliberate design decision rather than an oversight.

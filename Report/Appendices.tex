...
\begin{figure}[t]
	...
	\caption[Memory per-run maximum distributions (single-object)]{Distribution of per-run maximum memory across variants, \textbf{single-object benchmark}. Top to bottom: auxiliary \ac{GC} memory, Java heap, total process \ac{RSS}.}
...
\begin{figure}[t]
	...
	\caption[Memory per-run maximum distributions (multi-object)]{Distribution of per-run maximum memory across variants, \textbf{multi-object benchmark}. Top to bottom: auxiliary \ac{GC} memory, Java heap, total process \ac{RSS}.}

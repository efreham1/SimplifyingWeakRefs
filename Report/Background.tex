...
The order and concurrency model of these phases varies significantly between collectors. Serial and Parallel \ac{GCr} typically perform all phases in \ac{STW} pauses. G1 performs marking and sweeping mostly concurrently with short pauses for synchronisation. \ac{ZGC} performs marking, reference processing, and relocation concurrently, using barriers to maintain consistency with concurrent application threads.

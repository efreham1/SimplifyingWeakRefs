...
\begin{figure}[t]
	...
	\caption[Memory median percentage differences (single-object)]{Median percentage difference in per-run maximum memory usage relative to the \texttt{none} baseline, \textbf{single-object benchmark}. Lower is better. Top to bottom: auxiliary \ac{GC} memory, Java heap, total process \ac{RSS}.}
...
\begin{figure}[t]
	...
	\caption[Memory median percentage differences (multi-object)]{Median percentage difference in per-run maximum memory usage relative to the \texttt{none} baseline, \textbf{multi-object benchmark}. Lower is better. Top to bottom: auxiliary \ac{GC} memory, Java heap, total process \ac{RSS}.}
